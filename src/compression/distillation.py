...
def distillation_train_loop(teacher, student, train_data, test_data, distil_criterion, test_criterion, optimizer, epochs):
    for epoch in range(epochs):

        for batch_id, (data, hard_target) in enumerate(tqdm(train_data, desc='Distillation Training')):
